...
def calculate_invigilation_stats():
    ...
    total_report = InvigilationReport.query.filter(Exam.examStatus==True).count()
    total_invigilator = InvigilatorAttendance.query.filter(Exam.examStatus==True).count()
