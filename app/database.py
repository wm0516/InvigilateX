...
# UPDATE User SET userEmail='p21013604@student.newinti.edu.my' WHERE userId='15095776';       -> changing the data
...
class VenueSession(db.Model):
    ...
    backupInvigilatorId = Column(Integer, ForeignKey('User.userId'), default=1, nullable=False, server_default="1")
    ...
    CREATE TABLE VenueSession (
        ...
        backupInvigilatorId INT NOT NULL DEFAULT 1,
